...
app = Flask(__name__)
app.config['SECRET_KEY'] = 'ggerg5343j23g4222f232#@$2ff'
...
gravatar = flask_gravatar.Gravatar(app, size=100, rating='g', default='retro',
...
def show_post(post_id):
    ...
    return render_template("post.html",
                           post=requested_post, current_user=current_user,
                           form=comment_form)
